...
// own clock tree: PCLK2 is limited to 72Mhz and PCLK1 to 36Mhz, flash
// wait states scale with HCLK in 32Mhz steps, and the usb clock needs
// an explicit prescaler
static void
